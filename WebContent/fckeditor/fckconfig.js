...
FCKConfig.ProtectedSource.Add(/<a.*?><\/a>/g);
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About','Image','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	 '/',
	['Style','FontFormat','FontName','FontSize']
] ;
