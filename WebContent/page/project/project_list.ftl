   ...
   <div class="view view-main">
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="center sliding">头部</div>
            </div>
        </div>
                    ...
                    <div class="content-inner">
                        ...
                        <div class="market-list clear">
                            ...
                            <div class="list-content">
                                ...
                                <ol class="clear">
                                    <li><a href="javascript:;">某项目扩建</a></li>
                                    <li><a href="javascript:;">融资项目</a></li>
                                    <li><a href="javascript:;">河北-保定</a></li>
                                    <li><a href="javascript:;">2014年11月15日</a></li>
                                    <li><a href="javascript:;">关注/反馈</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
